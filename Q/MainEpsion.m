...
%     for gamma = Gamma
    ...
    for N = [50]       
        ...
        plot(MRe,'-o','MarkerIndices',1:10:length(MRe),'MarkerSize',7)
        hold on
...
pbaspect([3 4 1])
grid on
% legend('\gamma= 0.3','\gamma= 0.4','\gamma= 0.5','\gamma= 0.6','\gamma= 0.7','FontSize',15,'Location','SE');
legend('\epsilon= 1 bps','\epsilon= 100 bps','\epsilon= 200 bps','\epsilon= 300 bps','FontSize',15,'Location','SE');
